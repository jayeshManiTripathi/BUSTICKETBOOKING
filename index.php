...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">UPSRTC</a>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <h4>..........</h4>
                <p>
                    we are create here Bus ticket booking system for UPSRTC.
                    We provide users to book there ticket form here.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Cloud E- ticket system with AutoScalling for Upsrtc
                        </p>
        </footer>
    </div>
